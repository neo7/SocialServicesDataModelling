class ChartHandler
{
  ...
  createVisualizationPanel(dataframe)
  {
    ...
    console.log(chartData.getXArray());  // Array [ "2011", "2012", "2013", "2014", "2015", "2016" ]
    console.log(chartData.getYArray());  // Array [ Array[6], Array[6] ]
    console.log(chartData.getXLabel());  // Year
    console.log(chartData.getYLabel());  // [ "HomeDelieveredMeals", "CongregateDiningProgram" ]
